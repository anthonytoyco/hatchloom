 ...
 *
 * <p>Each BMC section is edited independently. Unknown section keys are rejected
 * with 400 Bad Request. Ownership of the parent SideHustle is validated before
 * any write operation.</p>
 */
@Service
public class BMCService {
     ...
     *
     * @param sideHustleId      the SideHustle UUID
     * @param sectionKeyString  the BMC section key (e.g. {@code "value_propositions"})
