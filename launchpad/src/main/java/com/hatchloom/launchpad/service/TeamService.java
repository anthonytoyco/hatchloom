 ...
 *
 * <p>The Team record is auto-created alongside its SideHustle. This service only
 * manages adding and removing {@link TeamMember} records within that team.</p>
 */
@Service
public class TeamService {
    ...
    public TeamMemberResponse addMember(UUID sideHustleId, UUID userId,
        ...
        Team team = teamRepository.findBySideHustle_Id(sideHustleId)
                .orElseThrow(() -> new ResponseStatusException(
                        HttpStatus.NOT_FOUND, "Team not found for SideHustle: " + sideHustleId));
     ...
     */
    @Transactional
    public void removeMember(UUID sideHustleId, UUID userId) {
        Team team = teamRepository.findBySideHustle_Id(sideHustleId)
                .orElseThrow(() -> new ResponseStatusException(
                        HttpStatus.NOT_FOUND, "Team not found for SideHustle: " + sideHustleId));
