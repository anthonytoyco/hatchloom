 ...
 *
 * <p>
 * Uses two filter chains to handle mixed public/protected routes:
 * </p>
 * <ol>
 * <li>{@code publicFilterChain} (Order 1) - matches the Position Status
 * Interface
...
public class SecurityConfig {
     ...
     *
     * <p>
     * Scoped to {@code GET /launchpad/positions/*&#47;status} via
     * {@link RegexRequestMatcher}. No OAuth2 resource server filter is applied
     * so ConnectHub can call this endpoint server-to-server without a user token.
     * </p>
     *
     ...
     *
     * <p>
     * Validates Bearer JWT tokens issued by the Auth service. Stateless - no
     * HTTP session is created. CSRF disabled (JWT API).
     * </p>
     *
     * @param http the {@link HttpSecurity} to configure
     * @return the configured {@link SecurityFilterChain}
