...
/**
 * An open role within a {@link SideHustle} that students can apply to via ConnectHub.
 *
 * <p>Positions are always created with {@code status = OPEN}. Transitions to
 ...
 * Position Status Interface: {@code GET /launchpad/positions/{id}/status}.</p>
 */
@Entity
