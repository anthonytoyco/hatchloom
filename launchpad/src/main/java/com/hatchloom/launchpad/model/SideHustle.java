 ...
 *
 * <p>A SideHustle is the parent of a {@link BusinessModelCanvas}, a {@link Team},
 * and zero or more {@link Position}s. It is created via the Factory Method pattern
 * and transitions between {@code IN_THE_LAB} and {@code LIVE_VENTURE} status.</p>
 *
 * <p>The {@code hasOpenPositions} flag is maintained by {@code PositionService}
 * whenever a position is created or its status changes.</p>
 */
@Entity
...
public class SideHustle {
    ...
    public void setStatus(SideHustleStatus status) { this.status = status; }

    public boolean isHasOpenPositions() { return hasOpenPositions; }
    public void setHasOpenPositions(boolean hasOpenPositions) { this.hasOpenPositions = hasOpenPositions; }

    public LocalDateTime getCreatedAt() { return createdAt; }

    public LocalDateTime getUpdatedAt() { return updatedAt; }

    public BusinessModelCanvas getBmc() { return bmc; }
