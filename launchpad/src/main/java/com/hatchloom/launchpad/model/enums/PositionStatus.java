 ...
 *   <li>{@code CLOSED} — position was closed without being filled (terminal state)</li>
 * </ul>
 *
 * <p>Valid transitions: {@code OPEN → FILLED}, {@code OPEN → CLOSED}.
 * {@code FILLED} and {@code CLOSED} are terminal — no further transitions allowed.</p>
 */
