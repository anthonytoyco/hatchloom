 ...
 *
 * <p>Assembled by {@link com.hatchloom.launchpad.aggregator.LaunchPadAggregator}
 * from data across the Sandbox and SideHustle modules. Not persisted.</p>
 *
 * <p>Design Doc reference: §4.1 Aggregator component, sequence diagram p. 14.</p>
 */
public class LaunchPadHomeView {
     ...
     * @param liveVenturesCount number of SideHustles with status {@code LIVE_VENTURE}
     * @param sandboxes         list of sandbox summaries
     * @param sideHustles       list of sideHustle summaries (each with open-position flag)
     */
    ...
    public int getInTheLabCount() { return inTheLabCount; }
    public int getLiveVenturesCount() { return liveVenturesCount; }
    public List<SandboxSummary> getSandboxes() { return sandboxes; }
    public List<SideHustleSummary> getSideHustles() { return sideHustles; }
}
