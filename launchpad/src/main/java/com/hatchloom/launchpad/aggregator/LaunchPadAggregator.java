 ...
 *
 * <p>Implements the Facade pattern: provides a single unified interface
 ...
 * service layer.</p>
 *
 * <p>Design Doc reference: §4.1 Aggregator component (component diagram p. 18),
 * sequence diagram p. 14, TC-Q2-004.</p>
 */
@Service
public class LaunchPadAggregator {
     ...
     *
     * <p>Reads from the Sandbox and SideHustle service layers only — no direct
     * DB writes or repository calls. Counts are derived from the returned lists
     * so they always stay in sync.</p>
     *
